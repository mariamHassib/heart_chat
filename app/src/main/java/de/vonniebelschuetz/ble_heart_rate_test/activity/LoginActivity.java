...
/**
 * Created by niebelschuetz on 04/19/16.
 *
 */
public class LoginActivity extends AppCompatActivity {
    ...
    private TextInputLayout inputLayoutName, inputLayoutEmail, inputLayoutAge, inputLayoutGender;
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * redirect him to menu_main activity
         * */
